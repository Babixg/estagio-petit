							            ...
							            while ($rs = $stmt->fetch(PDO::FETCH_OBJ)) {
							                echo "<div class='item col-lg-3 col-sm-12'>";
								                echo "<div class='row'>";
								                	...
								                	echo "<div> <a href=\"editar_prato.php?act=sel&btn_act=upd&id=".$rs->id_categoria."\"><i class='fas fa-pen'></i></a> <a href=\"?act=del&id=".$rs->id_categoria."\"><i class='fas fa-trash-alt'></i></a> </div>";
								                echo "</div>";
								            echo "</div>";
							            }
							        } else {
