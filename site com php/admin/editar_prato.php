...
<html>
	<head>
		...
		<title>Petit Poti | Editar Prato</title>
				...
				<div class="col-10" id="dashboard">
					...
					<div class="row">
						<div class="col-12">
							...
							<button type="button" class="btn btn-naveg me"> Categorias </button>
							<button type="button" class="btn btn-naveg" style="background-color: #b6d201;"> Pratos </button>
						</div> 
					</div>
					...
					<div class="row">
									            ...
									            while ($rs = $stmt->fetch(PDO::FETCH_OBJ)) {
									                echo "<div class='item-lista'>";
										                echo "<div class='row'>";
										                	...
										                	echo "<div class='col-2 align-self-center'><a href=\"?act=sel&btn_act=upd&id=".$rs->id_prato."\"><i class='fas fa-edit'></i></a></div>";
						...
						<div class="col-6">
							<!--Botão-->
							<div class="bloco d-flex align-content-center flex-wrap ">
								<button type="button" class="btn btn-criar align-self-center" onclick="Limpar()"> Novo Item </button>
							</div>
							<br>
							<!--Editar-->
								...
								<div>
									<form id="formulario" action="DALPrato.php" method="POST" name="form1">
										...
										<div class="row justify-content-end">
											<div class="col-3">
												<button type="button" class="btn" id="btn-cancelar" onclick="Limpar()" style="background-color: #e01f1f;"> Cancelar </button>
											</div>
											<div class="col-3">
