			...
			<div id="dashboard" class="col-lg-10 col-sm-12">
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<h1 class="tit-secao"> Categorias </h1>
						<button id="novo-item" onclick="window.location.href='nova-categoria.php'" type="button" class="btn-verde"> Nova Categoria </button>
					</div>
							        ...
							        if ($stmt->execute()) {
							            while ($rs = $stmt->fetch(PDO::FETCH_OBJ)) {
							                echo "<div class='item col-lg-3 col-sm-12'>";
							                	...
							                	echo "<div> <a href=\"editar-categoria.php?act=sel&btn_act=upd&id=".$rs->id_categoria."\"><i class='fas fa-pen'></i></a> <a href=\"?act=del&id=".$rs->id_categoria."\"><i class='fas fa-trash-alt'></i></a> </div>";
								            echo "</div>";
							            }
							        } else {
